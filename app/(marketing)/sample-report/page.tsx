...
export const metadata = getMetadata({
  title: "Sample Draft Estimate Report — CostPilot AI",
  description:
    "View a sample construction cost estimate report generated by CostPilot AI. See how materials, labor, and total costs are broken down across 8 categories.",
  path: "/sample-report",
});
